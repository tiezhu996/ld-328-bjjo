...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f0f2f5' }}>
      <Card title="CyFreshFood 易腐食品保质期追踪" style={{ width: 400 }}>
        <Tabs activeKey={tab} onChange={setTab} items={[
          ...
          { key: 'register', label: '注册', children: (
            <Form layout="vertical" onFinish={onFinish}>
              <Form.Item name="phone" label="手机号" rules={[{ required: true, len: 11 }]}><Input placeholder="11 位手机号" /></Form.Item>
              <Form.Item name="name" label="昵称" rules={[{ required: true }]}><Input /></Form.Item>
